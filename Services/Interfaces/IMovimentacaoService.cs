...
namespace ContaMente.Services.Interfaces
{
    ...
    {
        Task<Dictionary<DateTime, List<MovimentacaoDto>>> GetMovimentacoes(int? mes, int? ano, string userId, bool? entrada, bool? parcelada, List<int> categoriasIds, List<int> tiposPagamentoIds, List<int> responsaveisIds, List<int> cartoesIds);
